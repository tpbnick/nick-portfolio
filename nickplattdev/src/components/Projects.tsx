	...
	<div className="justify-center">
		<div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto justify-center pb-10">
			...
			<div className="card w-full md:w-96 bg-base-100 shadow-xl m-2 mx-auto hover:shadow-2xl transition-shadow duration-300">
				...
				<div className="card-body">
					...
					<div className="flex flex-wrap gap-2 justify-center">
						<a href="https://github.com/tpbnick/TriviaDart" target="_blank" rel="noopener noreferrer" aria-label="View TriviaDart on GitHub" className="text-white hover:text-blue-500 transition-colors duration-200">
			...
			<div className="card w-full md:w-96 bg-base-100 shadow-xl m-2 mx-auto hover:shadow-2xl transition-shadow duration-300">
				...
				<div className="card-body">
					...
					<p className="text-center">Simple markdown notes/pastebin web application</p>
					<div className="flex flex-wrap gap-2 justify-center">
						<a href="https://github.com/tpbnick/UnBIN" target="_blank" rel="noopener noreferrer" aria-label="View UnBIN on GitHub" className="text-white hover:text-blue-500 transition-colors duration-200">
							<FontAwesomeIcon icon={faGithub} className="w-6 h-6" />
						</a>
					</div>
					<div className="flex flex-wrap gap-2 justify-center">
			...
			<div className="card w-full md:w-96 bg-base-100 shadow-xl m-2 mx-auto hover:shadow-2xl transition-shadow duration-300">
				...
				<div className="card-body">
					...
					<div className="flex flex-wrap gap-2 justify-center">
						<a href="https://github.com/tpbnick/docs" target="_blank" rel="noopener noreferrer" aria-label="View Nick's Docs on GitHub" className="text-white hover:text-blue-500 transition-colors duration-200">
							<FontAwesomeIcon icon={faGithub} className="w-6 h-6" />
						</a>
					</div>
					<div className="flex flex-wrap gap-2 justify-center">
			...
			<div className="card w-full md:w-96 bg-base-100 shadow-xl m-2 mx-auto hover:shadow-2xl transition-shadow duration-300">
				...
				<div className="card-body">
					...
					<div className="flex flex-wrap gap-2 justify-center">
						<a href="https://github.com/tpbnick/nick-portfolio" target="_blank" rel="noopener noreferrer" aria-label="View Portfolio on GitHub" className="text-white hover:text-blue-500 transition-colors duration-200">
							<FontAwesomeIcon icon={faGithub} className="w-6 h-6" />
						</a>
					</div>
					<div className="flex flex-wrap gap-2 justify-center">
		...
		<div className="card w-full md:w-96 bg-base-100 shadow-xl m-2 mx-auto hover:shadow-2xl transition-shadow duration-300">
				...
				<div className="card-body">
					...
					<div className="flex flex-wrap gap-2 justify-center">
						<a href="https://github.com/tpbnick/soccerfront" target="_blank" rel="noopener noreferrer" aria-label="View SoccerFront on GitHub" className="text-white hover:text-blue-500 transition-colors duration-200">
							<FontAwesomeIcon icon={faGithub} className="w-6 h-6" />
						</a>
					</div>
					<div className="flex flex-wrap gap-2 justify-center">
